...
\section{Nicht ganzzahlige Lösungen}\label{sec_non_int}
...
Angenommen dies gelte nicht, dann könnten wir lokal den ganzzahligen Fluss als Typ 1 und die beiden anderen als Typ 2 definieren. Nach Theorem \ref{theo_int_flow} existiert nun ein zulässiger ganzzahliger Fluss von Typ 2 und wir würden einen ganzzahligen Fluss auf $\mathcal{N}_G$ erhalten. 
...
Die nächste Definition zeigt einen Weg auf, wie man mithilfe der alternierenden Zykel einen neuen zulässigen Fluss kann.
...
Das Umkehren von Z-Zykeln liefert einen weiteren Weg um aus dem Zuweisungs-Fluss $\tilde{\varphi}_z$ eines nicht-ganzzahligen zulässigen Flusses $\tilde{\varphi}$ ein FAA zu konstruieren. Wir teilen zuerst den Zuweisungs-Fluss in Z-Zykel auf. 
